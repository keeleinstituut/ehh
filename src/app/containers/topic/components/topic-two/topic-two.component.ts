...
export class TopicTwoComponent {
  ...
  wordsList1: WordsList = {
    ...
    items: [
      {
        word: '<u>ko<strong>nn</strong></u>',
        audioUrl: `${environment.audioMainUrl}/2_konn.wav`,
        description: 'omastav konna',
      },
      {
        word: '<u>to<strong>ss</strong></u>',
        audioUrl: `${environment.audioMainUrl}/2_toss.wav`,
        description: 'omastav tossu',
      },
      {
        word: '<u>ke<strong>l</strong>k</u>',
        audioUrl: `${environment.audioMainUrl}/2_kelk.wav`,
        description: 'omastav kelgu',
      },
    ],
  };
  wordsList2: WordsList = {
    ...
    items: [
      {
        word: '<u>to<strong>nn</strong></u>',
        audioUrl: `${environment.audioMainUrl}/2_tonn.wav`,
        description: 'omastav tonni',
      },
      {
        word: '<u>lo<strong>ss</strong></u>',
        audioUrl: `${environment.audioMainUrl}/2_loss.wav`,
        description: 'omastav lossi',
      },
      {
        word: '<u>te<strong>l</strong>k</u>',
        audioUrl: `${environment.audioMainUrl}/2_telk.wav`,
        description: 'omastav telgi',
      },
    ],
  };
}
